      ...
      <div className="relative py-24 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 md:p-12 shadow-xl">
            <h2 className="text-white font-bold text-[32px] md:text-[40px] mb-8 pb-4 border-b-2 border-[#F59E0B]/40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="group bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 shadow-2xl hover:bg-white/15 hover:scale-105 hover:shadow-[0_0_40px_rgba(212,175,55,0.3)] transition-all duration-500">
              <div className="mb-6">
                ...
                <h3 className="text-[#F59E0B] font-bold text-[24px] mb-4">Purpose</h3>
              </div>
              <p className="text-white/90 text-[16px] leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="text-[#F59E0B] font-bold text-6xl mb-4 group-hover:scale-110 transition-transform duration-500 drop-shadow-[0_0_10px_rgba(212,175,55,0.5)]">
                  {step.num}
                </div>
                <h3 className="text-white font-bold text-[22px] mb-3">{step.title}</h3>
                <div className="inline-block bg-[#F59E0B]/20 backdrop-blur-sm text-[#F59E0B] border border-[#F59E0B]/30 px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-wider mb-4 shadow-lg group-hover:bg-[#D4AF37]/30 transition-all duration-300">
                  {step.duration}
                </div>
