...
const services = [
  {
    ...
    dialog: {
      ...
      services: ["Network design & inventory optimization", "Sales & Operations Planning (S&OP) and service-level improvement", "Procurement transformation & supplier relationship management", "Transport, warehousing & distribution cost reduction", "Digital supply chain enablement"],
  ...
  },
  {
    ...
    img: OperationalImage, icon: RefreshCw,
    dialog: {
      headline: "Drive measurable productivity gains through process excellence and leadership alignment.",
      servicesLabel: "Services Include:",
      services: ["Process reengineering", "KPIs, SLAs, and performance governance frameworks", "Standard operating procedures development", "Capability-building & leadership alignment", "Continuous improvement culture"],
  ...
  },
  {
    ...
    img: WWO3Image, icon: Search,
    dialog: {
      headline: "De-risk transactions, stabilize post-deal operations, and embed governance.",
      servicesLabel: "Services Include:",
      services: ["Operational due diligence (buy-side)", "100-day stabilization programs", "Day-1 readiness and integration planning", "Synergy identification, tracking & value capture", "Integration office & delivery management"],
  ...
  },
  {
    ...
    img: DigitalImage, icon: Cpu,
    dialog: {
      headline: "Ensure successful technology adoption through rigorous governance and change management.",
      servicesLabel: "Services Include:",
      services: ["Digital strategy and roadmap development", "ERP selection, implementation oversight & stabilization", "Business process reengineering", "AI-enabled process automation", "Change management and user adoption programs", "Benefits tracking and realization"],
  ...
  },
  {
    ...
    img: StrategyImage, icon: TrendingUp,
    dialog: {
      headline: "Bridge the strategy-execution gap with pragmatic program governance.",
      servicesLabel: "Services Include:",
      services: ["Strategy translation into operational initiatives", "PMO leadership and program governance", "Implementation roadmap development", "Risk & dependency management", "Benefits realization and executive reporting"],
  ...
  },
  {
    ...
    img: ExecutiveImage, icon: Users,
    dialog: {
      headline: "Strategic counsel for leadership teams navigating complex operational challenges.",
      servicesLabel: "Services Include:",
      services: ["Operational risk and performance advisory", "Growth strategy operational readiness assessment", "M&A transaction advisory", "Digital transformation governance", "Board effectiveness and governance design", "Succession planning & leadership support"],
  ...
  return (
    <div className="group bg-white rounded border border-[#0F172A]/10 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full">
      <div className="aspect-video w-full relative overflow-hidden bg-[#0F172A]">
        <ImageWithFallback src={service.img} alt={service.title} className="w-full h-full object-cover transition-all duration-500 group-hover:scale-105 group-hover:brightness-110" />
        <div className="absolute top-4 left-4 w-10 h-10 bg-[#0F172A]/80 backdrop-blur rounded flex items-center justify-center text-[#F59E0B]">
          <service.icon className="w-5 h-5" />
        </div>
      </div>
      <div className="p-8 flex flex-col flex-1">
        <h3 className="text-[#0F172A] font-semibold text-[20px] mb-4 line-clamp-2 leading-tight">{service.title}</h3>
        ...
        <button onClick={() => setOpen((o) => !o)}
          ...
          style={{ color: open ? "#F59E0B" : "#0F172A" }} aria-expanded={open}>
          {open ? "Close" : "Learn More"}
          <ChevronDown className="w-4 h-4 transition-transform duration-300" style={{ transform: open ? "rotate(180deg)" : "rotate(0deg)" }} />
        </button>
        <div style={{ display: "grid", gridTemplateRows: open ? "1fr" : "0fr", transition: "grid-template-rows 0.38s cubic-bezier(0.4,0,0.2,1)" }}>
          <div style={{ overflow: "hidden" }}>
            <div style={{ marginTop: "16px", borderRadius: "8px", background: "rgba(15,23,42,0.88)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: "1px solid rgba(245,158,11,0.28)", boxShadow: "0 6px 28px rgba(15,23,42,0.22)", padding: "18px 18px 14px", opacity: open ? 1 : 0, transform: open ? "translateY(0)" : "translateY(-6px)", transition: "opacity 0.3s ease 0.08s, transform 0.3s ease 0.08s" }}>
              <p style={{ color: "rgba(255,255,255,0.82)", fontSize: "12.5px", lineHeight: "1.65", fontStyle: "italic", borderLeft: "3px solid #F59E0B", paddingLeft: "10px", marginBottom: "14px" }}>{service.dialog.headline}</p>
              <p style={{ color: "#F59E0B", fontSize: "10.5px", fontWeight: "700", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "8px" }}>{service.dialog.servicesLabel}</p>
              <ul style={{ marginBottom: "14px", paddingLeft: 0, listStyle: "none" }}>
                {service.dialog.services.map((item, i) => (
                  <li key={i} style={{ display: "flex", alignItems: "flex-start", gap: "8px", color: "rgba(255,255,255,0.72)", fontSize: "12.5px", lineHeight: "1.6", marginBottom: "5px" }}>
                    <span style={{ width: "5px", height: "5px", borderRadius: "50%", background: "#F59E0B", flexShrink: 0, marginTop: "7px" }} />
                    {item}
                  </li>
                ))}
              </ul>
              <div style={{ background: "rgba(245,158,11,0.10)", border: "1px solid rgba(245,158,11,0.22)", borderRadius: "6px", padding: "10px 12px" }}>
                <p style={{ color: "#F59E0B", fontSize: "10px", fontWeight: "700", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "4px" }}>Typical Impact</p>
                <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "12px", lineHeight: "1.6" }}>{service.dialog.impact}</p>
              </div>
            </div>
          </div>
        </div>
...
export function WhatWeOffer() {
  return (
    <div className="bg-white">
      <SEO
        title="Our Services | MK Consulting & Advisory"
        description="Supply chain optimization, operational excellence, M&A integration, digital transformation and executive advisory services across Africa."
        canonical="https://www.muigaikamau.pro/what-we-offer"
      />
        ...
        <div className="relative rounded-lg overflow-hidden">
          ...
          <div className="relative z-10 p-8 md:p-12">
            ...
            <div className="mt-12 text-center">
              <Link to="/contact-us" className="inline-flex items-center justify-center bg-[#F59E0B] text-[#0F172A] px-8 py-4 rounded font-bold text-lg hover:bg-[#d97706] transition-colors gap-2">
