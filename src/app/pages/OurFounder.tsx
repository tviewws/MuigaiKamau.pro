import { Target, GraduationCap, TrendingUp, Users } from "lucide-react";
...
export function OurFounder() {
  const impactMetrics = [
    { prefix: "KES ", end: 8.2, decimals: 1, suffix: "Bn", label: "Cost Savings Delivered", sub: "across large-scale transformation programmes" },
    { prefix: "US$", end: 31, decimals: 0, suffix: "M+", label: "OPEX Reductions", sub: "achieved in a single year at Airtel / Zain Group" },
    { prefix: "", end: 95, decimals: 0, suffix: "%+", label: "SLA Compliance", sub: "improved from below 20% in client environments" },
    { prefix: "", end: 22, decimals: 0, suffix: "+", label: "Operating Companies", sub: "SOPs and risk frameworks deployed across" },
    { prefix: "", end: 6, decimals: 0, suffix: "+", label: "African Markets", sub: "Kenya, Nigeria, Tanzania, DRC, Rwanda & more" },
    { prefix: "US$", end: 7, decimals: 0, suffix: "M+", label: "Logistics Savings", sub: "from warehouse consolidation and infrastructure rollouts" },
  ];
            ...
            <div className="w-full lg:w-2/5 shrink-0">
              <div className="bg-white/80 backdrop-blur-sm border border-[#0F172A]/10 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-500 sticky top-24">
                <div className="aspect-[3/4] bg-[#0F172A] rounded-xl overflow-hidden">
                  <img src={founderImage} alt="Muigai Kamau - Founder" className="w-full h-full object-cover" />
                </div>
                <div className="mt-6 text-center">
                  ...
                  <p className="text-[#4B5563] text-[14px] mt-1">Muigai Kamau Consulting & Advisory</p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row-reverse gap-12 items-start">
            ...
            <div className="flex-1 space-y-5">
              {boardRoles.map((role, i) => (
                <div key={i} className="bg-gradient-to-br from-[#F9FAFB] to-white border border-[#0F172A]/10 rounded-2xl p-6 shadow-md hover:shadow-xl hover:scale-[1.01] transition-all duration-500">
      ...
      <div className="relative py-12 overflow-hidden bg-[#0F172A]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <div className="flex-1 space-y-5">
              {[
                { degree: "Executive MBA", institution: "Strathmore Business School", detail: null },
                { degree: "Certificate of Specialization in Strategy", institution: "Harvard Business School Online", detail: "Disruptive Strategy · Sustainable Business Strategy · Strategy Execution" },
