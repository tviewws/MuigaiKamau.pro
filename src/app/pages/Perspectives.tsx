        ...
        items: [
          {
            ...
            body: "Many transformation programs are designed using frameworks borrowed from Europe or North America. These models assume stable infrastructure, mature supplier ecosystems, reliable data, and consistent governance. In African markets, these assumptions often collapse due to incomplete data, uneven supplier capability, infrastructure constraints, and informality embedded in daily operations. When transformation designs ignore these realities, execution breaks down immediately.",
          },
          {
            title: "Strategy Without Execution Muscle",
            body: "Transformation often stops at strategy definition. KPIs are defined, roadmaps are approved, but operating rhythms, accountability, and decision rights are never embedded. The failure point is rarely the strategy itself — it is the absence of execution discipline once complexity increases.",
          },
          {
            title: "Technology Before Process Discipline",
            body: "ERP and digital tools are frequently deployed before core processes are stabilized. Inefficiency is automated instead of eliminated. Systems go live, dashboards look impressive, yet operational performance barely shifts.",
          },
          {
            title: "No Capability Transfer",
            body: "Many programs rely heavily on external consultants. When they exit, results fade. Transformation without capability transfer is not transformation — it is dependency.",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            body: "Successful programs begin with rapid, evidence-based diagnostics that establish baselines and prioritize realistic interventions.",
          },
          {
            title: "Execution-Led Design",
            body: "Governance, RACI structures, decision cadence, and performance rhythms are embedded from day one. Where execution mechanisms are institutionalized early, momentum consistently sustains beyond the initial program phase.",
          },
          {
          ...
          },
          {
            ...
            body: "The most effective programs involve side-by-side execution, with ownership deliberately transferred to internal teams.",
          },
        ],
      },
    ],
        ...
        items: [
          {
            ...
            body: "Availability may look stable only because of excessive buffers or emergency purchasing. Supply chain risk often surfaces as the earliest value destroyer.",
          },
          {
          ...
          },
          {
            ...
            body: "Decision rights are unclear, escalation paths are informal, and governance exists on paper but not in practice.",
          },
          {
            title: "People and Capability Risk",
            body: "Critical knowledge sits with a few individuals. When they exit, operational stability erodes rapidly.",
          },
        ],
      },
      {
        ...
        type: "prose",
        body: "Effective operational diligence examines process stability, execution capability, governance effectiveness, integration readiness, and first-100-day risk. It asks a simple question: Can this organization sustain and improve performance under new ownership?",
      },
      {
        heading: "Unlocking Value After the Deal",
        type: "prose",
        body: "Where investors engage early with operational leaders who have lived through multiple integrations, outcomes change. Integration stabilizes faster, credibility improves, and value capture accelerates. These outcomes are rarely accidental — they are the product of experience gained across multiple deal cycles.",
      },
    ],
    ...
    sections: [
      {
        ...
        type: "prose",
        body: "The missing middle sits between strategic intent and operational reality. It includes governance structures, operating rhythms, decision rights, capability development, and accountability mechanisms. When this layer is weak, even the best strategies fail.",
      },
      {
      ...
      },
      {
        ...
        type: "prose",
        body: "Organizations that close the strategy-execution gap embed governance alongside metrics, translate strategy into executable work, build capability through real delivery, and stay engaged until results become routine.",
      },
    ],
        ...
        >
          <div className="flex-1">
            <div className="flex flex-wrap items-center gap-3 mb-4">
              <span className="bg-[#F59E0B] text-[#0F172A] px-3 py-1 rounded text-[11px] font-bold uppercase tracking-wider">
                {article.category}
              </span>
